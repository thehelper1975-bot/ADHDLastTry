...
- **Improved**: Implemented robust streak calculation logic (daily & weekly).
- **Improved**: Dopamine Menu now uses a rich list of suggestions and randomizes selection.
- **Updated**: Added web support (`react-native-web`) for easier testing.
...
- `src/utils/streakCalculator.ts` contains the logic for streaks.
