...
- Added interactive Dopamine Menu with random task suggestions based on energy levels.
- Implemented robust UTC-based streak calculator.
- Added platform-specific habit deletion confirmations.
- Added full Edit Habit functionality via long-press and icon buttons.
- Setup `expo export -p web` compatibility by resolving peer dependencies.
