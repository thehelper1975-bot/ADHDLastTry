...
- **Improved Home Screen:** Added randomized Dopamine Menu suggestions and interactive habit completion checkboxes.
- **Improved Streak Logic:** Implemented robust consecutive day tracking in `src/utils/streakCalculator.ts`.
...
- Streak calculation relies on UTC dates, ensure consistency.
