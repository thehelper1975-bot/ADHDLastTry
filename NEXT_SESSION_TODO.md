...
**Date Created:** 2026-01-29 (Updated 2026-01-30)
...
- **Enhanced Habit Features**: Implemented habit editing, robust streak calculation (with yesterday grace period), and web support.
- **Data Sync**: Ensured Habit List refreshes correctly after editing.
...
- Web support is enabled via `react-native-web`.
- Playwright verification scripts confirmed "Edit Habit" flow.
...
- `adhd-habit-companion/src/screens/OnboardingScreen.tsx` (Added accessibility)
- `adhd-habit-companion/package.json` (Added web deps)
