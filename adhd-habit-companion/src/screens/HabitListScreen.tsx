      ...
      return (
          ...
          >
              <TouchableOpacity
                ...
                accessibilityRole="button"
                accessibilityLabel={isCompleted ? `Mark ${item.title} as incomplete` : `Mark ${item.title} as complete`}
              >
              ...
              <View style={styles.actions}>
                  <TouchableOpacity onPress={() => navigation.navigate('AddHabit', { habitId: item.id })} accessibilityRole="button" accessibilityLabel="Edit Habit" style={styles.actionBtn}>
                      <Pencil size={20} color={COLORS.textSecondary} />
                  </TouchableOpacity>
                  <TouchableOpacity onPress={() => handleDelete(item.id)} accessibilityRole="button" accessibilityLabel="Delete Habit" style={styles.actionBtn}>
