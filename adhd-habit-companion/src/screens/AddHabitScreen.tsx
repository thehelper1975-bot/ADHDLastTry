...
import { View, Text, StyleSheet, TextInput, TouchableOpacity, Switch, SafeAreaView } from 'react-native';
...
export default function AddHabitScreen() {
  ...
  useEffect(() => {
    if (habitId && !initialized && habits.length > 0) {
