...
export default function AddHabitScreen() {
  ...
  useEffect(() => {
    if (habitId && !hasLoaded) {
      // Fetch directly from AsyncStorage to avoid depending on the global hook array
      // which might overwrite changes if it refreshes in the background
