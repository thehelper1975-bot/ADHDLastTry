...
import { getDopamineSuggestion } from '../constants/dopamineMenu';
...
export default function HomeScreen() {
  ...
  const handleEnergySelect = (level: EnergyLevel) => {
      ...
      setSuggestion(getDopamineSuggestion(level));
  };
        ...
        <ScrollView contentContainerStyle={styles.content}>
            ...
            {energyLevel && (
                <View style={styles.suggestionCard}>
                    ...
                    <TouchableOpacity onPress={() => setSuggestion(getDopamineSuggestion(energyLevel))} style={{ marginTop: 8 }}>
                         <Text style={{ color: COLORS.secondary, fontSize: 12 }}>Try another</Text>
                    </TouchableOpacity>
                </View>
            )}
            ...
            {incompleteHabits.length > 0 ? (
                incompleteHabits.slice(0, 3).map(habit => (
                    <View key={habit.id} style={styles.habitCard}>
                        ...
                        >
                             {/* Empty because filtered list only has incomplete */}
                        </TouchableOpacity>
                        <View style={{ flex: 1 }}>
