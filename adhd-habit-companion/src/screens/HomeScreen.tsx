...
export default function HomeScreen() {
  ...
  const incompleteHabits = habits.filter(h => {
      ...
      if (h.frequency === 'daily') {
          ...
          // Check if any completed date is within the current week (Mon-Sun)
          const now = new Date();
